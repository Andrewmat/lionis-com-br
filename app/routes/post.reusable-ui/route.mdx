...
![Componente switch de exemplo, com a label "airplane mode" e a posição de desligado](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/2a4rnivst1nbhoucgf1l.png)
